...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file=r'test_gui/content/txt.png')
        btn_open_dialog = tk.Button(toolbar, text='Добавить позицию', command=self.open_dialog, bg='white', bd=0, 
...
class DB:
    def __init__(self):
        self.conn = sqlite3.connection(r'test_gui/content/finance.db')
